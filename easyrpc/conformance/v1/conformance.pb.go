...
type EchoTrailerRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Input         string                 `protobuf:"bytes,1,opt,name=input,proto3" json:"input,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *EchoTrailerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type EchoTrailerResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Output        string                 `protobuf:"bytes,1,opt,name=output,proto3" json:"output,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *EchoTrailerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type CountTrailerRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Count         int32                  `protobuf:"varint,1,opt,name=count,proto3" json:"count,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *CountTrailerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type CountTrailerResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Index         int32                  `protobuf:"varint,1,opt,name=index,proto3" json:"index,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *CountTrailerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_easyrpc_conformance_v1_conformance_proto_rawDesc = "" +
	"\n" +
	"(easyrpc/conformance/v1/conformance.proto\x12\x16easyrpc.conformance.v1\"#\n" +
	...
	"\x05index\x18\x01 \x01(\x05R\x05index\"*\n" +
	"\x12EchoTrailerRequest\x12\x14\n" +
	"\x05input\x18\x01 \x01(\tR\x05input\"-\n" +
	"\x13EchoTrailerResponse\x12\x16\n" +
	"\x06output\x18\x01 \x01(\tR\x06output\"+\n" +
	...
	"\x05Count\x12$.easyrpc.conformance.v1.CountRequest\x1a%.easyrpc.conformance.v1.CountResponse0\x01\x12Q\n" +
	"\x04Fail\x12#.easyrpc.conformance.v1.FailRequest\x1a$.easyrpc.conformance.v1.FailResponse\x12e\n" +
	"\n" +
	"StreamFail\x12).easyrpc.conformance.v1.StreamFailRequest\x1a*.easyrpc.conformance.v1.StreamFailResponse0\x01\x12]\n" +
	"\bEchoMeta\x12'.easyrpc.conformance.v1.EchoMetaRequest\x1a(.easyrpc.conformance.v1.EchoMetaResponse\x12N\n" +
	"\x03Big\x12\".easyrpc.conformance.v1.BigRequest\x1a#.easyrpc.conformance.v1.BigResponse\x12f\n" +
